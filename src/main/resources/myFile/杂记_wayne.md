...
| 执行以下命令会彻底清除所有容器。 docker system prune -a -f
...
20.1.1 端口映射 例如：外网18080->内网8080

在cmd中，直接执行

```.java
netsh interface portproxy add v4tov4 listenport=18080 connectaddress=主机内网IP connectport=8080
```

配置成功后8080和18080都可以访问，可以在安全组进行相应的限制
