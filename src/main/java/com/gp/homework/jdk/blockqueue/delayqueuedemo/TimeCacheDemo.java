package com.gp.homework.jdk.blockqueue.delayqueuedemo;
 ...
 */
public class TimeCacheDemo<K, V> {
    ...
    public TimeCacheDemo(){
        Thread t = new Thread(this :: dameonCheckOverdueKey);
        t.setDaemon(true);
        t.start();
    }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int cacheNumber = 10;
        int liveTime ;
        TimeCacheDemo<String, Integer> cache = new TimeCacheDemo<>();
